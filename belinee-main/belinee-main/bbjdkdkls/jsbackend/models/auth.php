    ...
    <script>
        ...
        function toggleAuthForm() {
            if (loginForm.classList.contains('active')) {
                ...
                loadRegCaptchaImage(); // Загружаем новую капчу для регистрации
            } else {
                // Переключаемся на вход
                registerForm.classList.remove('active');
                loginForm.classList.add('active');
                toggleAuthBtn.textContent = 'Зарегистрироваться';
                loadCaptchaImage(); // Загружаем новую капчу для авторизации
            }
        ...
        function handleLogin(event) {
            ...
            if (!captchaInput || !currentCaptchaToken) {
            ...
            (async () => {
                try {
                    ...
                    if (data.success) {
                        ...
                        // При любой ошибке обновляем капчу
                        refreshCaptcha();
                    ...
                    refreshCaptcha(); // Обновляем капчу при ошибке сети
                }
            })();
        }
        ...
        function handleRegister(event) {
            ...
            if (!captchaInput || !currentRegCaptchaToken) {
                showError('Пожалуйста, введите код с картинки');
                return;
            }
            ...
            (async () => {
                try {
                    ...
                    showError('Ошибка сети. Попробуйте ещё раз.');
                    loadRegCaptchaImage(); // Обновляем капчу при ошибке сети
                }
            })();
        }
